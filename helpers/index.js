(function (){
  ...
  helpers.saveUser = function(req, res, body) {
    currentUser.uuid = body.uuid;
    currentUser.token = body.token;

    req.session.currentUser = currentUser;
    console.log("set cookie " + currentUser);
    res.status(200);
  ...
  helpers.getCurrentUser = function(req) {
    let logged_in = req.cookies.logged_in;
